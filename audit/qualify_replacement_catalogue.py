...
INPUT = Path("audit/replacement-stock-candidates-6-qualified-input.json")
OUTPUT = Path("audit/replacement-stock-candidates-6-live-audit.json")
...
for i, row in enumerate(rows, 1):
    ...
    print(f"[{i:02d}/6] {sym} ...", flush=True)
